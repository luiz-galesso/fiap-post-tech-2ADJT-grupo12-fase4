package com.fase4.techchallenge.fiap.msgerenciamentoclientes.cliente.infrastructure;
...
public class ClienteControllerIT {
    ...
    void devePermitirCadastrarCliente() {
        ...
        given()
                ...
                .when()
                .post("/ms-gerenciamento-clientes/clientes")
                .then()
    ...
    void devePermitirAtualizarCliente() {
        ...
        given()
                ...
                .when()
                .put("/ms-gerenciamento-clientes/clientes/{id}", cliente.getEmail())
                .then()
    ...
    void devePermitirObterCliente() {
        ...
        given()
                ...
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .when()
                .get("/ms-gerenciamento-clientes/clientes/{id}", cliente.getEmail())
                .then()
    ...
    void devePermitirRemoverCliente() {
        ...
        given()
                ...
                .contentType(MediaType.APPLICATION_JSON_VALUE)
                .when()
                .delete("/ms-gerenciamento-clientes/clientes/{id}", cliente.getEmail())
                .then()
                .statusCode(HttpStatus.OK.value());
    }
